...
Numbers <- c("900-1000","880-899","860-879","800-859","780-799","760-779",
             "700-759","680-699","660-679","600-659","")
Numbers2 <- c("450-500","440-449","430-439","400-429","390-399","380-389",
             "350-379","340-349","330-339","300-329","")

grade_539 <- cbind(Grade, Numbers)
grade_439 <- cbind(Grade, Numbers2)

kable(grade_539, "html") %>%  
  kable_styling(bootstrap_options = c("striped", "hover", "responsive", full_width = F, position = "float_left"))
kable(grade_439, "html") %>%  
